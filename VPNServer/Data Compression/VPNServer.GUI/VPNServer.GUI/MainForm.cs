    ...
    public partial class MainForm : Form
    {
        ...
        private void StartPacketCapture()
        {
            ...
            while (true)
            {
                ...
                // Update packet data to the label
                CapturedPacketLabel.Invoke((Action)(() =>
                    CapturedPacketLabel.Text = "Captured Packet: " + packetData));
        ...
        private void UpdateStatus(string message)
        {
            ...
            {
                StatusLabel.Invoke((Action)(() => StatusLabel.Text = $"Status: {message}"));
            }
            else
            {
